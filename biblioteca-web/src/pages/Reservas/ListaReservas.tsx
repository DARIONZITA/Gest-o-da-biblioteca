...
import { Bookmark, Search, X, CheckCircle, Clock } from 'lucide-react';
...
const ListaReservas: React.FC = () => {
  ...
  const filtered = reservas.filter(r => {
    const matchesSearch =
      r.tituloLivro.toLowerCase().includes(searchTerm.toLowerCase()) ||
      r.nomeUsuario.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="animate-slide-up">
          <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Reservas</h1>
          <p className="text-sm text-gray-400 mt-0.5 font-medium">Gerencie as reservas de livros</p>
        </div>
          ...
          {loading ? (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-xs text-gray-500">
                      <div>
                        ...
                        <span className="font-medium text-gray-700">{res.nomeUsuario}</span>
                      </div>
                      <div>
            ...
            <Card padding="lg">
              <EmptyState
                ...
                message={searchTerm ? 'Tente buscar com outros termos' : 'Não há reservas registadas'}
              />
            </Card>
          )}
        </div>
